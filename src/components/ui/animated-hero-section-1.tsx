...
// Reusable image-backed hero with a translucent overlay header, a
// centered editorial stack, and glass-style CTAs. Sourced from the
// twentyfirst.ai pattern — kept as a standalone primitive in /ui so
// it can be composed by any marketing surface.
...
export function AnimatedHero({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-[var(--bg-brand)]",
        className,
      )}
    >
      <div
      ...
      {(logo || navLinks || topRightAction) && (
        ...
        >
          ...
          {topRightAction && <div className="hidden md:block">{topRightAction}</div>}
        </motion.header>
      )}
